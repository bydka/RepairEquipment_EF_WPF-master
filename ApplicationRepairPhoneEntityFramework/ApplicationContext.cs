...
namespace ApplicationRepairPhoneEntityFramework
{
    public class ApplicationContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Employee>().HasData(new Employee { ID_Employee = "Директор", Password = "123", 
                FIO = "Гостев Герман Германович", ID_Position = 5, Series_Number_Password = "0000 000000", Address = "Воронеж", 
